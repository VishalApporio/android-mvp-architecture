...
public class LocationManagerClass implements
    ...
    public LocationManagerClass(Context context, boolean showDialog) {
    ...
    public void executeService(final ApporioLocationListener apporioLocationListener) {
    ...
    public void getsamlocationlistener(final ApporioLocationListener apporioLocationListener) {
        this.apporioLocationListener = apporioLocationListener;
    }
