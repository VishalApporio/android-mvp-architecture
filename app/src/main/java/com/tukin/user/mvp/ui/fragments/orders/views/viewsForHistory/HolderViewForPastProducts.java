...
public class HolderViewForPastProducts {

    CategoryProduct mcategoryProduct;
    Context mContext;
    ...
    public HolderViewForPastProducts(Context context, CategoryProduct categoryProduct_) {
        mContext = context;
        mcategoryProduct = categoryProduct_;
    }
