package com.tukin.user.mvp.adapters;
...
//    }
    ...
    public Object instantiateItem(ViewGroup view, int position) {
        ...
        Glide.with(context)
                .load(ApiEndPoint.ENDPOINT_FOR_IMAGE + mpromotional_data.getResponse().getPromotional_data().get(position).getPromotional_image())
                .asBitmap()
                .centerCrop()
                .into(myImage);
