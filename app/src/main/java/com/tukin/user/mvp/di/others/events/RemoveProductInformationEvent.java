package com.tukin.user.mvp.di.others.events;

/**
 * Created by lenovo on 5/2/2018.
 */

public class RemoveProductInformationEvent {

    public Integer selector_id;
    public String selector_name, selector_availability, selector_price;
    ;

    public RemoveProductInformationEvent(Integer selector_id, String selector_name, String selector_availability, String selector_price) {
